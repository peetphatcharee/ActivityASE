...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-9">
            <div class="card">
                <div class="card-header">รายการนักศึกษา</div>
                   ...
                   <br> <table class="table table-hover">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href ="edit_st{{$key->id}}_{{$Ac_ID}}" class="btn btn-secondary"><img src="<?php echo asset('img/edit.png' );  ?> " width="20" height="20" >&nbsp;แก้ไข</a></td>
